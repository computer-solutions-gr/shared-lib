...
def clarke_error_grid(ref_values, pred_values, title_string):
    """Plots Clarke Error Grid and calculates zone statistics.

    Takes in lists of reference and predicted glucose values, and a title string.
    Checks values are valid and prints warnings if not.
    Plots reference vs predicted values on a Clarke Error Grid.
    Calculates number of points in each zone A-E.
    Returns matplotlib plot and list of zone counts.

    For use in evaluating continuous glucose monitoring prediction accuracy.
    """
    # sourcery skip: bin-op-identity, low-code-quality
